...
public class WebConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				.cors().and().authorizeRequests().antMatchers("/user/signup").anonymous()
				.antMatchers("/**").hasAnyAuthority("USER", "ADMIN")
				.anyRequest().authenticated().and().formLogin().defaultSuccessUrl("/user/authed")
				.successHandler(successHandler()).failureHandler(failureHandler()).and().rememberMe().and()
